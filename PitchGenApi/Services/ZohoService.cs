...
namespace PitchGenApi.Services
{
    public class ZohoService
    {
        ...
        public ZohoService(IConfiguration configuration, HttpClient httpClient, AppDbContext Context)
        {
    ...
    {{
      ""data"":[
        ...
        public async Task<string> CreateCustomer(ZohoCustomerRequest customer, int clientId)
        {
            ...
            var customerData = JsonConvert.DeserializeObject<ZohoCustomerResponse>(responseContent);
            ...
            if (customerData?.customer != null)
            {
                ...
                {
                    ClientId = clientId,
                    CustomerId = customerData.customer.contact_id,
                    ContactId = customerData.customer.contact_id,
                    PrimaryContactPersonId = customerData.customer.primary_contactperson_id,
                    DisplayName = customerData.customer.display_name,
                    ContactName = customerData.customer.contact_name,
